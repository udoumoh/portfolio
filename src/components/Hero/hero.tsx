            ...
            >
              ...
              >
                  ...
                  <div className="space-y-6">
                    ...
                    <motion.div className="space-y-4" variants={itemVariants}>
                      ...
                      <p className="text-lg md:text-xl text-gray-600 font-medium max-w-lg">
                        Crafting digital experiences that matter. Specializing
                        in{" "}
                ...
                >
                  ...
                  solutions. My approach combines technical expertise with
                  design thinking, creating systems that are both beautiful and
                  functional.
                </motion.p>
